...
@click.option("--which_c", type=str, default='c1')
...
def main(data, outdir, g_ckpt, e_ckpt,
    ...
    for idx in pbar:
        ...
        gen_img2 = G.get_final_output(styles=rec_ws_1, camera_matrices=camera2,img_c=(which_c,c1))
        rec_ws_2, c2 = E(gen_img2,which_c=which_c)
        rec_ws_2 += ws_avg

        # define loss
        loss_dict['loss_c'] = F.smooth_l1_loss(c1, c2).mean() * lambda_c
