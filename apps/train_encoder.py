...
def main(data, outdir, g_ckpt, e_ckpt,
    ...
    torch.multiprocessing.spawn(ori_main, args=(data, outdir, g_ckpt, e_ckpt, max_steps, batch, lr, vgg, l2, adv, tensorboard), nprocs=world_size, join=True)


def ori_main(rank, data, outdir, g_ckpt, e_ckpt,
